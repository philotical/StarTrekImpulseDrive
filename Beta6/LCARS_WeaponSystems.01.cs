...
{
    class LCARS_WeaponSystems : PartModule
    {
        ...
        private void CreateTarget(Vessel v)
        {
            ...
            nT.Vector = newVector;
            nT.PhotonTorpedo = new LCARS_PhotonTorpedo();
            nT.PhotonTorpedo.setVPI(this.VPI, PowSys);
        ...
        internal void FirePhaser(Target t)
        {
            ...
            */
            ...
            float power = PT2.L1_usage + (t.PhaserYield * PT2.L2_usage);
        ...
        private bool hasTorpedoLauncher;
        internal void Draw_TargetList()
        {
            ...
            foreach (Target t in this.TargetList)
            {
                ...
                try // in case the target ship explodes..
                {
                    ...
                    {
                        GUILayout.Label("Torpedo launcher? They're not going to be installed until next Tuesday");
        ...
        internal void TorpedosInstalled(bool hasTorpedoLauncher)
        {
            this.hasTorpedoLauncher = hasTorpedoLauncher;
        }
    }
    ...
    class Target
    {
        ...
        public LCARS_PhotonTorpedo PhotonTorpedo { get; set; }
