...
namespace Philotical
{
    ...
    public class LCARS_ImpulseVesselType
    {
    ...
    public sealed class ImpulseVessel_manager
    {
        ...
        internal Dictionary<string, LCARS_ImpulseVesselType> ImpulseVesselList;
        public static LCARS_ImpulseVesselType IVship;

        private ImpulseVessel_manager()
        {
            this.ImpulseVesselList = new Dictionary<string, LCARS_ImpulseVesselType>();
        }
        ...
        public void populateImpulseVesselList(Vessel currentVessel)
        {
            ...
            foreach (Vessel v in vesselList)
            {
                ...
                {
                    if (!v.rootPart.Modules.Contains("LCARS_Tricorder"))
                    {
            ...
            foreach (KeyValuePair<string, LCARS_ImpulseVesselType> pair in this.getImpulseVesselList())
            {
        ...
        public Dictionary<string, LCARS_ImpulseVesselType> getImpulseVesselList()
        {
        ...
        public bool IsImpulseVessel(Vessel v)
        {
            ...
            {
                foreach (LCARS_ImpulseDrive vesselPart in p.FindModulesImplementing<LCARS_ImpulseDrive>())
                {
        ...
        public LCARS_ImpulseVesselType AddImpulseVessel(string key)
        {
            if (!this.ImpulseVesselList.ContainsKey(key))
            {
                LCARS_ImpulseVesselType activeImpulseVessel = new LCARS_ImpulseVesselType();
        ...
        public bool IsFormationLeaderDefined()
        {
            ...
            foreach (KeyValuePair<string, LCARS_ImpulseVesselType> pair in this.ImpulseVesselList)
            {
        ...
        public bool GetFormationLeaderSetting_bool(string key=null)
        {
            ...
            if(key!=null)
            {
                LCARS_ImpulseVesselType leader = null;
