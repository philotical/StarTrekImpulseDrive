...
{
    class LCARS_TractorBeam : PartModule
    {
        ...
        public void setVPI(LCARS_VesselPartsInventory thisVPI, LCARS_PowerSystem thisPowSys)
        {
            ...
            PT1 = this.PowSys.setPowerTaker("TractorBeam", "SubSystem", 1250, 0, 0);
        }
            ...
            Vessel Parent = FlightGlobals.ActiveVessel;
                ...
                if (check_distance < 2000F)
                {
                    ...
                    */
                    ...
                    float total_force = b.force;
                    float charge = 120;
                    float tot = charge + total_force * 12 * Time.deltaTime;
                    float power = PT1.L2_usage * b.force;
                    this.PowSys.draw(PT1.takerName, power);
