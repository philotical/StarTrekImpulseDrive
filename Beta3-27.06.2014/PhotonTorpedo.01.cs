...
namespace Philotical
{
    ...
    class _PhotonTorpedo : MonoBehaviour
    {
    ...
    public class Explosion : MonoBehaviour
    {
        ...
        public void Initialize(Transform parent, float radius)
        {
            ...
            //Debris
            GameObject go_debris = new GameObject("LazorEffect Debris");
            ...
            GameObject go_explosion = new GameObject("Explosion");
    ...
    class PhotonTorpedo : MonoBehaviour
    {
        ...
        private Dictionary<string, PhotonTorpedoType> TorpedoList;
        Explosion expl=null; 
        ...
        {
            this.TorpedoList = new Dictionary<string, PhotonTorpedoType>();
